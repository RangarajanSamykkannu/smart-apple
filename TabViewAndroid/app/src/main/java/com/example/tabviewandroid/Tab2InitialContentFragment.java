...
public class Tab2InitialContentFragment extends Fragment {

    public Tab2InitialContentFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_tab2_initial_content, container, false);
