...
public class Tab5InitialContentFragment extends Fragment {

    public Tab5InitialContentFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_tab5_initial_content, container, false);
