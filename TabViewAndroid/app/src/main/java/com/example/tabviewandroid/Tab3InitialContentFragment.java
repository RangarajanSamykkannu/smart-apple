...
public class Tab3InitialContentFragment extends Fragment {

    public Tab3InitialContentFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_tab3_initial_content, container, false);
