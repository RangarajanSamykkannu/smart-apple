...
public class Tab1InitialContentFragment extends Fragment {

    public Tab1InitialContentFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_tab1_initial_content, container, false);
